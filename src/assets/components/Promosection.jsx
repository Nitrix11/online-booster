        ...
        <div className="promo-section">
          ...
          <div className="promo-content">
            <div className="text-content">
              <h3 className="Amplify">
                Amplify Your Social Media Reach in Just 3 Months!
              </h3>

              <p className="p1 j1">
                Join our <span>Online Presence Booster</span> program and see
                measurable
                <span>
                  <br />
                </span>
                growth on your social platforms at an un beatable rate.{" "}
              </p>
              <p className="p2">
                <b>Lock in 3 moths for a 50% discount!</b>
              </p>
              <div className="two">
                <p className="p3">
                  <b>$225.00/3 months</b>
